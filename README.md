...
- **🔥 热门榜单**（A股 / 港股 / 美股 成交量前五，东方财富 push2 免费接口）：**页面不出现任何榜单/排名表**，
  ...
  **AI 量化流动性报告**的研判输入，只保留 AI 对三个榜单成交量的研判报告；
- **💧 AI 量化流动性报告**：新增最近收盘 **A股 / 港股** 流动性研判（东方财富 push2 免费接口），
  一对一对比两个市场的样本成交额、TOP10 成交集中度、涨跌扩散比、成交额加权涨跌、平均换手率等
  聚合指标，并给出可复现的 AI 规则评分（0-100）与「资金扩散 / 头部集中 / 防御收缩」定性及
  AI 资金结论，**不展示个股排名表**，明确标注非投资建议；
